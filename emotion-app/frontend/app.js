...
(() => {
  ...
  const EMOTIONS = ['happiness','neutral','surprise','sadness','anger','disgust','fear'];
  ...
  function handleResult(msg) {
    if (msg.rendered_b64) {
      $renderedVideo.src = 'data:image/jpeg;base64,' + msg.rendered_b64;
    }
    if (msg.model && $modelBadge) {
      $modelBadge.textContent = 'Model: ' + msg.model;
    }
